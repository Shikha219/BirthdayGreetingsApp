...
/* this java file is adapter class for ChoosebdayCardActivity */


public class Row extends RecyclerView.Adapter<Row.MyViewHolder> {
    private List<String> itemsName;
    private List<String> yourWish;
    int images[];
    Context context;
    public Row(Context ct, ArrayList<String> nameList,ArrayList<String> wishList, int image[]){
        context = ct;
        itemsName = nameList;
        yourWish = wishList;
        images = image;
